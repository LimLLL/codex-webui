...
export const ErrorCode = {
  ...
  terminal: {
    ...
    lost: 'terminal.session_lost',
    staleSession: 'terminal.stale_session',
    recoveryLimit: 'terminal.recovery_limit',
    launchFailed: 'terminal.launch_failed',
    cleanupFailed: 'terminal.cleanup_failed',
    disconnected: 'terminal.disconnected',
    operationFailed: 'terminal.operation_failed',
  ...
  // ── Pending Approvals ──────────────────────────────────────────────
  approvals: {
    instanceRequired: 'approvals.instance_required',
    invalidResponse: 'approvals.invalid_response',
    deliveryUnknown: 'approvals.delivery_unknown',
