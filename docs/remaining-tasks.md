...
- [x] `GET /api/threads/branch-trees`、`GET /api/threads/:id/branch-tree`、`GET /api/threads/:id/branch-state`：提供版本树与 compact guard 状态（branch-state 纯本地拓扑，外部 fork 检测只在 compact 写路径）。
